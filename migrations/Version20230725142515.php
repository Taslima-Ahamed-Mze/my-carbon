 ...
 */
final class Version20230725142515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_skills (id INT NOT NULL, collaborator_id UUID NOT NULL, skill_id INT NOT NULL, level_id INT NOT NULL, created_by UUID DEFAULT NULL, updated_by UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))');
